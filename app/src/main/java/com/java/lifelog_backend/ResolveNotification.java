...
public class ResolveNotification extends AppCompatActivity {
    ...
    public void tipClick(final String notifyText) {
        ...
        //设置反面按钮
        builder.setNegativeButton(R.string.skip_reminder, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(context, R.string.choose_skip_reminder, Toast.LENGTH_SHORT).show();
        ...
        //设置中立按钮
        builder.setNeutralButton(R.string.remind_latter, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(context,R.string.choose_remind_latter,Toast.LENGTH_SHORT).show();
        ...
        //设置正面按钮
        builder.setPositiveButton(R.string.open_now, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
